...
#define ULTRASONIC_BACK_TRIG		PIN0_bm
#define ULTRASONIC_BACK_ECHO		PIN1_bm
#define ULTRASONIC_BACK_CHMUX		EVSYS_CHMUX_PORTA_PIN1_gc
...
#define ULTRASONIC_LEFT_TRIG		PIN6_bm
#define ULTRASONIC_LEFT_ECHO		PIN7_bm
#define ULTRASONIC_LEFT_CHMUX		EVSYS_CHMUX_PORTA_PIN7_gc
